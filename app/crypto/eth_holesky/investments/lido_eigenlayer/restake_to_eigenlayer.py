...
from .constants import EIGENLAYER_STRATEGY_MANAGER, STETH, STETH_EIGENLAYER_STRATEGY
...
restake_to_eigenlayer = {
    ...
    "application_data": {
        ...
        "contract_address_on_explorer": f"https://holesky.etherscan.io/address/{EIGENLAYER_STRATEGY_MANAGER}"
    },
